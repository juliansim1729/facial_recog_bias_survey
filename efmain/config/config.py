...
config.embedding_size = 512 # embedding size of model # originally 512
config.momentum = 0.9
config.weight_decay = 5e-4
config.batch_size = 8 # batch size per GPU # originally 128
config.lr = 0.1
config.output = "elasticface/efmain/output/ElasticFace-Cos" # train model output folder
...
config.loss="ElasticCosFace"  #  Option : ElasticArcFace, ArcFace, ElasticCosFace, CosFace, MLLoss, ElasticArcFacePlus, ElasticCosFacePlus

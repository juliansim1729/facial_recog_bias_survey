...
#800, 300
def detect_face(image_paths,  SAVE_DETECTED_AT, default_max_size=230,size = 85, padding = 0.25):
    cnn_face_detector = dlib.cnn_face_detection_model_v1('dlib_models/mmod_human_face_detector.dat')
    sp = dlib.shape_predictor('dlib_models/shape_predictor_5_face_landmarks.dat')
    base = 1000 #2000  # largest width and height
...
if __name__ == "__main__":
    ...
    predidct_age_gender_race("outputs.csv", SAVE_DETECTED_AT)
